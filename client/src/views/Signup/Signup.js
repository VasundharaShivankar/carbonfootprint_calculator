      ...
      <div className="container col-xl-10 col-xxl-8 px-4 py-5">
        <div className="row align-items-center g-lg-5 py-5">
          <div className="col-lg-6 text-center text-lg-start">
            <h1 className="fw-bold text-body-emphasis mb-3 mx-5">
              Join Us Now
            </h1>
          ...
          <div className="col-md-10 mx-auto col-lg-5 box">
            ...
            >
              <img
                src={img3}
                alt="Signup"
                style={{ height: "150px", width: "167px", borderRadius: "5px" }}
                className="loginimg align-items-center"
              />
              <input
                type="email"
              ...
              />
              <button
                className="w-50 btn btn-submit border-info btn-md border d-flex d-flex justify-content-center align-items-center"
                type="submit"
              >
                Sign Up
              </button>
