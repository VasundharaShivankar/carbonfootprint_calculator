                    ...
                    <div className="carousel-item active">
                        ...
                        <div className="container">
                            <div className="carousel-caption text-start text-black">
                                ...
                                <p><Link className="btn btn-lg btn-info" to="/calculate">Start Calculating</Link></p>
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className="container">
                            <div className="carousel-caption text-light">
                                ...
                                <p><Link className="btn btn-lg btn-info" to="/suggestions">Learn More</Link></p>
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item">
                        ...
                        <div className="container">
                            <div className="carousel-caption text-start">
                                ...
                                <p><Link className="btn btn-lg btn-info" to="/chatbot">Chat Now</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
