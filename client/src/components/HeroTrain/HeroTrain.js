            ...
            <div className="container col-xxl-8 px-4 py-5">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                    ...
                    <div className="col-lg-6">
                        <h1 className="fs-1 fw-bold text-info-emphasis lh-1 mb-3 align-items-left">UNDERSTAND YOUR FARM'S CARBON IMPACT</h1>
                        <p className="lead text-body-secondary align-items-left" style={{ fontSize: '20px' }}>
                        ...
                        <div className="d-grid d-md-flex justify-content-md-start">
                            <Link to="/calculator">
                                <button type="button" className="btn btn-outline-warning align-items-left btn-lg px-4 me-md-2">Start Calculating</button>
                            </Link>
                            <Link to="/contact">
                                <button type="button" className="btn btn-outline-secondary align-items-left btn-lg px-4">Contact Us</button>
                            </Link>
                        </div>
                    </div>
                </div>
